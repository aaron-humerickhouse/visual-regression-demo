...
exports.config = {
    ...
    //
    // Test runner ScreenshotService.js
    ...
    services: [
      'selenium-standalone',
      [
      'image-comparison', // Used for image taking abilities
        // The options
        {
    ...
    // it and to build ScreenshotService.js around it. You can either apply a single function or an array of
    ...
    onPrepare: async (config, capabilities) => {
      try {
        const ScreenshotService = require(`${testPath}/services/ScreenshotService`).default;
